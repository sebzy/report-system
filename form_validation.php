...
function showUser(str) {
  ...
  <section id="container" class="">
                ...
                <form class="form-validate form-horizontal" method="post" action="uploadv3.php" enctype="multipart/form-data">
                    <input type=hidden name=st value= 0>
                             ...
                             <label for="cname" class="control-label col-lg-2" >Client<span class="required">*</span></label>
                                          <div class="col-lg-10">
      <select name= "client_name"    onchange="showUser(this.value)" class="form-control" type="text" onclick="myFunction()" required >
   ...
   echo "<option value= '".$x ."' name='client_name' >    ".$x."</option> ";
                                        ...
                                        <!-- php script ends here -->
                                           ...
                                           // echo "<input type='hidden' value ='".$row['client_name'] ."' name='client_name'  id ='".$row['client_name'] ."' > "; ?> -->
