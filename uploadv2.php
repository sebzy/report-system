...
//         $newFilePath = "upload/" . $_FILES['files']['name'][$i];
...
//   $images1 = mysql_real_escape_string($images1);
...
foreach ($_POST['notes'] AS $notes) {
 ...
 // echo $notes;
  ...
  $result = "INSERT INTO data_table (notes ,image, timestamp1, report_date, client_name) VALUES ('".$notes."','".$target."','".$timestamp1."','".$report_date."','".$client_namex."' )";
...
mysql_select_db("smart_security", $con);
    ...
    $query = "SELECT * FROM data_table WHERE timestamp1 = '".$timestamp1."' ";
  ...
  '; } ?>
      ...
      <div class="text-right">
            <div class="credits">
                ...
                -->
                <a href="https:">Business Bootstrap Themes</a> by <a href="https:///">BootstrapMade</a>
            </div>
        </div>
  </section>
