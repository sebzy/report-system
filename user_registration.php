...
<html lang="en">
  ...
  <section id="container" class="">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="form_validation.html">Report form </a></li>
                      </ul>
                  </li>       
                  <!--<li class="sub-menu">
                      <a href="javascript:;" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa fa-bars"></i> REGISTER USER</h3>
                    <ol class="breadcrumb">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="user_registration.php" enctype="multipart/form-data">
...
//here query check weather if user already registered so can't register again.  
    $check_email_query=" SELECT * FROM users_table WHERE user_email= '".$user_email."' ";  
...
//insert the user into the database.  
    $insert_user="INSERT INTO users_table (user_name,user_pass,user_email) VALUES ('$user_name','$user_pass','$user_email')";  
