...
<!-- the js script to work on the automatic drop down list -->
...
echo "<br><select name='client_name' onchange=\"reload(this.form)\"><option value=''>Select one</option>";
