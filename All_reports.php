    ...
    <!--sidebar start-->
      ...
      <section id="main-content">
          ...
          <div class="row">
              ...
              <!-- page start-->
              <div style ="float:center;"><h5><b>CLIENT REPORT DETAILS</b></h5></div>
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
...
<!-- php code for displaying the all the reports made -->
                            <table class="table">
...
//use of the inner joins to qeury both the images and the notes from the database
  ...
  $query = " SELECT  image_table.image, notes_table.notes ,notes_table.notes_date, notes_table.timestamp1 ,notes_table.location ,notes_table.client_name
FROM image_table  
