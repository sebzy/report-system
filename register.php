...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li> 
                      <a class="" href="form_validationv6.php">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa fa-bars"></i> REGISTER CLIENT</h3>
                    <ol class="breadcrumb">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="register_client.php" enctype="multipart/form-data">
                                     
                                      
                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">Client name</label>
                                          <div class="col-lg-10">
  ...
  <!-- container section end -->
    ...
    <script src="js/scripts.js"></script>
     <script src="dynamic_location.js" type="text/javascript"></script>
